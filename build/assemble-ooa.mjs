#!/usr/bin/env node
/* Assemble Oracle of Ages (game 11, Game Boy Color) into an app-ready bundle knowledge/ooa/app-data.json,
...
const O = join(dirname(fileURLToPath(import.meta.url)), "..", "knowledge", "ooa");
...
const STATUS_PICKS = [
  ["Harp of Ages", "stasis"], ["Wooden Sword", "sword"], ["Roc's Feather", "leaf"], ["Switch Hook", "magnesis"],
];
...
const out = {
  id: "ooa", label: "Oracle of Ages", short: "Ages",
  REGIONS,
  SHRINES: [],
  ARMOR: { sets: [] },
  BESTIARY,
...
console.log("OoA chapters:", REGIONS.length, "| steps:", steps);
...
console.log("\n✓ wrote knowledge/ooa/app-data.json");
