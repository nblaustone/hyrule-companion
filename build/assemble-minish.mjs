#!/usr/bin/env node
/* Assemble The Minish Cap (game 9, Game Boy Advance) into an app-ready bundle knowledge/minish/app-data.json,
...
const O = join(dirname(fileURLToPath(import.meta.url)), "..", "knowledge", "minish");
...
const STATUS_PICKS = [
  ["Smith's Sword", "sword"], ["Gust Jar", "stasis"], ["Cane of Pacci", "stasis"], ["Roc's Cape", "leaf"],
];
...
const out = {
  id: "minish", label: "The Minish Cap", short: "Minish",
  REGIONS,
  SHRINES: [],
  ARMOR: { sets: [] },
  BESTIARY,
...
console.log("Minish chapters:", REGIONS.length, "| steps:", steps);
