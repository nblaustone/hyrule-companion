...
const data = {
  ...
  VIDEO_GUIDE: K("video-guide.json"),
...
const BOTW_GAME =
  ...
  `REGIONS, SHRINES, ARMOR, BESTIARY, COOKING, KOROKS, WORLD, ECONOMY, COMPENDIUM, SIDE_QUESTS, TOWERS, GREAT_FAIRIES, REGION_MAPS, MAP_COORDS, VIDEO_GUIDE, MAP_NODES, MAP_BEASTS,` +
