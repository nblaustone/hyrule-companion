#!/usr/bin/env node
/* Assemble A Link Between Worlds (game 7, Nintendo 3DS) into an app-ready bundle knowledge/albw/app-data.json,
...
const O = join(dirname(fileURLToPath(import.meta.url)), "..", "knowledge", "albw");
...
const STATUS_PICKS = [
  ["Ravio's Bracelet", "magnesis"], ["Master Sword", "sword"], ["Pegasus Boots", "stasis"], ["Bow", "bow"],
];
...
const out = {
  id: "albw", label: "A Link Between Worlds", short: "ALBW",
  REGIONS,
  SHRINES: [],
  ARMOR: { sets: [] },
  BESTIARY,
...
console.log("ALBW chapters:", REGIONS.length, "| steps:", steps);
