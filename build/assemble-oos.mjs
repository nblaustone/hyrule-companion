#!/usr/bin/env node
/* Assemble Oracle of Seasons (game 10, Game Boy Color) into an app-ready bundle knowledge/oos/app-data.json,
...
const O = join(dirname(fileURLToPath(import.meta.url)), "..", "knowledge", "oos");
...
const STATUS_PICKS = [
  ["Rod of Seasons", "stasis"], ["Wooden Sword", "sword"], ["Roc's Feather", "leaf"], ["Magnetic Gloves", "magnesis"],
];
...
const out = {
  id: "oos", label: "Oracle of Seasons", short: "Seasons",
  REGIONS,
  SHRINES: [],
  ARMOR: { sets: [] },
  BESTIARY,
...
console.log("OoS chapters:", REGIONS.length, "| steps:", steps);
